...
def extract_genes(genome, annotation, extragenic, intragenic, ignore_small_genes, train_val_split, tpms, target_chromosomes: Tuple[str, ...]) -> Dict[str, Tuple[List[np.ndarray], List[np.ndarray], List[np.ndarray]]]:
    extracted_seqs = {}
